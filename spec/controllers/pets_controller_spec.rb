  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pet as @pet" do
        ...
        post :create, {:pet => { "title" => "invalid value" }}, valid_session
        assigns(:pet).should be_a_new(Pet)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pet" do
        ...
        Pet.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => pet.to_param, :pet => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the pet as @pet" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Pet.any_instance.stub(:save).and_return(false)
        put :update, {:id => pet.to_param, :pet => { "title" => "invalid value" }}, valid_session
        assigns(:pet).should eq(pet)
      end
